...
public class ExtTruleInstanceMccDAOHibernate extends BeGenHibernateDaoSupport implements ExtTruleInstanceMccDAO {    
     ...
     */
    public ExtTruleInstanceMcc getExtTruleInstanceMcc(java.lang.String pkey) {
    	ExtTruleInstanceMcc truleInstanceMcc = (ExtTruleInstanceMcc) getHibernateTemplate().get(ExtTruleInstanceMcc.class, pkey);
    ...
    public ExtTruleInstanceMcc saveExtTruleInstanceMcc(ExtTruleInstanceMcc truleInstanceMcc) {
        return (ExtTruleInstanceMcc) getHibernateTemplate().merge(truleInstanceMcc);
    }
     ...
     *  @param pkey TruleInstanceMcc主键.
     */
    public void removeExtTruleInstanceMcc(java.lang.String pkey) {
    	ExtTruleInstanceMcc truleInstanceMcc = getExtTruleInstanceMcc(pkey);
     ...
     *  @return List.
     */
    public List getExtTruleInstanceMccList(ExtTruleInstanceMcc truleInstanceMcc) {
        Criteria criteria = getSession().createCriteria(ExtTruleInstanceMcc.class).add(
     ...
     *  @return List.
     */
    public List getExtTruleInstanceMccListOfQuery(Map queryMap) {
        ...
        Criteria criteria = getSession().createCriteria(ExtTruleInstanceMcc.class);
     ...
     *  @return List.
     */
    public List getExtTruleInstanceMccListOfNoAuthorityQuery(Map queryMap) {
        String hsql = (String) queryMap.get("_hsql");
        if (hsql != null) {
            Query query = getSession().createQuery("from cn.com.brilliance.begen.model.TruleInstanceMcc where " + hsql);
            return query.list();
