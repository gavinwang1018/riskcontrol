...
public class VariousChannelsReportServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4373432525538521889L;
	/**
	 * 
	 */
	/**
			...
			try {
				jasperPrint = JasperFillManager.fillReport(request.getSession()
						.getServletContext().getResourceAsStream(
								"/t_report/VariousChannels.jasper"), map,
						Tools.getConnection());
