...
public class VariousBranchesReportServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8056785106285590132L;
	/**
	 * 
	 */
			...
			try {
				jasperPrint = JasperFillManager.fillReport(request.getSession()
						.getServletContext().getResourceAsStream(
								"/t_report/VariousBranches.jasper"), map,
						Tools.getConnection());
