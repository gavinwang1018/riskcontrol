...
public class VariousIndustriesReportServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7135172400396456638L;
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("VariousIndustriesReportServlet.doPost()");
			...
			try {
				jasperPrint = JasperFillManager.fillReport(request.getSession()
						.getServletContext().getResourceAsStream(
								"/t_report/VariousIndustries.jasper"), map,
						Tools.getConnection());
