...
<f:view>
	...
	<h:form id="triskcaseForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcase.t_riskcase_form_edit_inst_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseForm.save}" tabindex="1" 
					  onclick=" if(!validateTriskcaseForm(document.getElementById('triskcaseForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_riskcase_form_edit_inst.2c90834917523149011752347c09002a']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="t_riskcase/t_riskcase_form_inst_ViewForm" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink onclick="window.open('../t_riskcase/t_riskcase_list_queryByBelong_List.faces','_self','');return false">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="返回" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_form_edit_inst.2c90834917523149011752347d23002d']}" />
			</f:facet>	
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="casefrom" value="#{triskcaseForm.triskcase.casefrom}"  readonly="false"  tabindex="2"  style="width:86%" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
				          ...
				          <h:selectOneMenu id="transMcc" value="#{triskcaseForm.triskcase.transMcc}"  readonly="false"  tabindex="7"  style="width:86%" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="acquireInstName" value="#{triskcaseForm.triskcase.acquireInstName}"  readonly="false"  tabindex="8"  style="width:86%" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
						...
						<f:verbatim><span class="mustw"></span></f:verbatim>
		               <h:inputText id="mchntCd" value="#{triskcaseForm.triskcase.mchntCd}" style="width:'86%'" tabindex="9"   maxlength="15"  styleClass="edit_input" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <h:inputText id="relativeTransNum" value="#{triskcaseForm.triskcase.relativeTransNum}"  style="width:'86%'"   tabindex="10" styleClass="edit_input">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <h:inputText id="relativeTransAmt" value="#{triskcaseForm.triskcase.relativeTransAmt}" styleClass="edit_input" style="width:'86%'" tabindex="11" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="belongToInst" value="#{triskcaseForm.triskcase.belongToInst}"  readonly="false"  tabindex="12"  style="width:86%" >
                            <f:selectItems value="#{extSelectItems.belongToInstList}"/>
				          </h:selectOneMenu >	
                       </h:panelGroup>
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			        <h:panelGroup>
			           <be:inputDate id="processLimit" value="#{triskcaseForm.triskcase.processLimit}" style="width:86%" tabindex="13"   styleClass="edit_input" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="warnLevel" value="#{triskcaseForm.triskcase.warnLevel}"  readonly="false"  tabindex="14"  style="width:86%" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="triggerContent" value="#{triskcaseForm.triskcase.triggerContent}" rows="4" style="width:'86%';"   readonly="false" tabindex="15" styleClass="edit_textarea" >
                          </h:inputTextarea>			
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="riskContent" value="#{triskcaseForm.triskcase.riskContent}" rows="4" style="width:'86%';"   readonly="false" tabindex="16" styleClass="edit_textarea" >
                          </h:inputTextarea>			
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="comments1" value="#{triskcaseForm.triskcase.comments1}" rows="4" style="width:'86%';"   readonly="false" tabindex="17" styleClass="edit_textarea" >
                          </h:inputTextarea>			
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="comments2" value="#{triskcaseForm.triskcase.comments2}" rows="4" style="width:'86%';"   readonly="false" tabindex="18" styleClass="edit_textarea" >
                          </h:inputTextarea>			
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="comments3" value="#{triskcaseForm.triskcase.comments3}" rows="4" style="width:'86%';"   readonly="false" tabindex="19" styleClass="edit_textarea" >
                          </h:inputTextarea>			
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="comments4" value="#{triskcaseForm.triskcase.comments4}" rows="4" style="width:'86%';"   readonly="false" tabindex="20" styleClass="edit_textarea" >
                          </h:inputTextarea>			
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="comments5" value="#{triskcaseForm.triskcase.comments5}" rows="4" style="width:'86%';"   readonly="false" tabindex="21" styleClass="edit_textarea" >
                          </h:inputTextarea>			
