...
<f:view>
	...
	<h:form id="triskcaseForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcase.t_riskcase_form_add_dw_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseForm.save}" tabindex="1" 
					  onclick=" if(!validateTriskcaseForm(document.getElementById('triskcaseForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_riskcase_form_add_dw.2c90834916d142fa0116d2f43212007c']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="t_riskcase/t_riskcase_form_view_dw_ViewForm" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
	...
	<h:panelGroup>
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="mustws"></span></f:verbatim>
                   <h:panelGroup>
