...
<f:view>
	...
	<div class="mytab1">
	    <ul class="myTabBar1">
	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcase.t_riskcase_form_view_EditForm.heading']}" /></a></li>
	    </ul>
	</div>
	<a4j:jsFunction name="loadTriskcase" action="#{triskcaseForm.loadTriskcase}" reRender="triskcaseForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['triskcase.t_riskcase_form_view_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="casefrom" value="#{triskcaseForm.triskcase.casefrom}"  readonly="false"  tabindex="4"  style="width:86%" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="mchntId" value="#{triskcaseForm.triskcase.mchntId}" style="width:'86%'" tabindex="5"   maxlength="32"  styleClass="edit_input" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="mchntName" value="#{triskcaseForm.triskcase.mchntName}" style="width:'86%'" tabindex="6"   maxlength="255"  styleClass="edit_input" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="status" value="#{triskcaseForm.triskcase.status}"  readonly="false"  tabindex="8"  style="width:86%" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="belongToInst" value="#{triskcaseForm.triskcase.belongToInst}"  readonly="false"  tabindex="11"  style="width:86%" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			        <h:panelGroup>
			           <be:inputDate id="processLimit" value="#{triskcaseForm.triskcase.processLimit}" style="width:86%" tabindex="12"   styleClass="edit_input" >
					     <f:convertDateTime pattern="yyyy-MM-dd" timeZone="GMT+8"/>
		               </be:inputDate>
   			         </h:panelGroup>
                               </h:panelGroup>	            <h:inputHidden />
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="acquireInstName" value="#{triskcaseForm.triskcase.acquireInstName}"  readonly="false"  tabindex="13"  style="width:86%" >
                            <f:selectItems value="#{extSelectItems.belongToInstList}"/>
				          </h:selectOneMenu >	
                       </h:panelGroup>
