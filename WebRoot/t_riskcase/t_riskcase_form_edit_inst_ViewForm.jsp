...
try{
	parent.historyIframe.addHistory('/t_riskcase/t_riskcase_form_edit_inst_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="triskcase.t_riskcase_form_edit_inst_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseForm.triskcase.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'triskcaseForm');"><a href="#"><h:outputText value="#{text['triskcase.t_riskcase_form_edit_inst_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{triskcaseForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_form_edit_inst.2c90834917523149011752347c29002b']}" />
...
<f:verbatim><li></f:verbatim>
					<h:commandLink
						...
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_form_edit_inst.2c90834917523149011752347c48002c']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
