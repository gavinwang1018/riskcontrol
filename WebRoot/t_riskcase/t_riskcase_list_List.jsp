...
function compareDateOfCreate() {
	...
	<h:form id="triskcaseQuery" >
		<a4j:jsFunction name="queryTriskcases" action="#{triskcaseList.query}" reRender="triskcasePanel,triskcases,triskcase_scroll" oncomplete="document.getElementById('triskcaseList').style.display='block';parent.dyniframesize('mainFrame')" />   
		...
		<h:panelGrid columns="2" cellspacing="0" cellpadding="0"  columnClasses="width50percent,width50percent" styleClass="width100percent"> 
             ...
             <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
				<h:outputLabel styleClass="fontnormal" for="belongToInst" value="#{text['triskcase.belongToInst']}  #{text['query.equal']}" />				
				<h:panelGroup>
				<h:selectOneMenu id="belongToInst" value="#{triskcaseList.queryFields.belongToInst}">
                 <a4j:support event="onchange" action="#{triskcaseList.getRuleGroup}" reRender="ruleGroup" />
					<f:selectItem itemLabel="------" itemValue=""/>
                   <f:selectItems value="#{triskcaseList.belongToInstList}"/>
				</h:selectOneMenu >				
				</h:panelGroup>
			  </h:panelGrid>

             <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
				<h:outputLabel styleClass="fontnormal" for="ruleGroup" value="规则组  #{text['query.equal']}" />				
				<h:panelGroup>
				<h:selectOneMenu id="ruleGroup" value="#{triskcaseList.queryFields.ruleGroup}">
					<f:selectItem itemLabel="------" itemValue=""/>
                   <f:selectItems value="#{triskcaseList.truleGroupItems}"/>
				</h:selectOneMenu >				
				</h:panelGroup>
			  </h:panelGrid>
	        ...
	        <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
             ...
             <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
				<h:outputLabel styleClass="fontnormal" for="backCnt" value="#{text['triskcase.backCnt']} >=" />				
				<h:panelGroup>
             ...
             <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
				<h:outputLabel styleClass="fontnormal" for="submit2Inst" value="#{text['triskcase.submit2Inst']} #{text['query.equal']}" />				
				<h:panelGroup>
				<h:selectOneMenu id="submit2Inst" value="#{triskcaseList.queryFields.submit2Inst}">
					<f:selectItem itemLabel="------" itemValue=""/>
...
<br>
		<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcase.t_riskcase_list_List.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{triskcaseList.edit}"  onclick="if(rowIndexVarOfTriskcase == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_riskcase_list.2c90834916d142fa0116d31314fd0285']}" />
				<t:updateActionListener property="#{actionParameter.successAction}" value="t_riskcase/t_riskcase_form_edit_EditForm" />
			</h:commandLink>							
	</h:panelGroup>
<f:verbatim></li></f:verbatim>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{triskcaseList.view}" onclick="if(rowIndexVarOfTriskcase == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkViewImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_riskcase_list.2c908349169f7cda0116a3f5bf7403e7']}" />
...
<f:verbatim></li></f:verbatim>
			...
			<t:dataTable id="triskcaseDataTable" var="triskcase"
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="isNew" arrow="true">		                
							<h:outputText value="" />
						</t:commandSortHeader>	
				</f:facet>
				<be:outputText id="isNew" value="*" style="color:red" rendered="#{triskcase.isNew == 1}" />
				</t:column>
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="action" arrow="true">		                
							<h:outputText value="案例调查结论" />
						</t:commandSortHeader>	
				</f:facet>
				<be:outputText id="action" value="#{triskcase.action}" >
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="way" arrow="true">		                
							<h:outputText value="案例处理措施" />
						</t:commandSortHeader>	
				</f:facet>
				<be:outputText id="way" value="#{triskcase.way}" >
                            <f:selectItem itemLabel="----" itemValue=""/>
		...
		<h:panelGrid id="triskcase_scroll" columns="2" styleClass="scrollerTable" columnClasses="column1,column2">
