...
<f:view>
	...
	<div class="mytab1">
	    <ul class="myTabBar1">
	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcase.t_riskcase_form_view_otherway_EditForm.heading']}" /></a></li>
	    </ul>
	</div>
	<a4j:jsFunction name="loadTriskcase" action="#{triskcaseForm.loadTriskcase}" reRender="triskcaseForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['triskcase.t_riskcase_form_view_otherway_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="status" value="#{triskcaseForm.triskcase.status}"  readonly="false"  tabindex="7"  style="width:86%" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="warnLevel" value="#{triskcaseForm.triskcase.warnLevel}"  readonly="false"  tabindex="13"  style="width:86%" >
