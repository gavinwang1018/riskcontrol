...
<f:view>
	...
	<h:form id="triskcaseForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcase.t_riskcase_form_inst_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <be:inputAmount id="allTransAmt" value="#{triskcaseForm.triskcase.allTransAmt}" styleClass="edit_input" style="width:'86%'" tabindex="6" >
					   <s:commonsValidator type="floatRange" min="0" max="1000000000" arg="#{text['triskcase.allTransAmt']}" client="true" server="false" />
				     </be:inputAmount>
                               </h:panelGroup>	            <h:inputHidden />
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
				<h:outputLabel for="allTransNum" styleClass="outputlabel" value="#{text['triskcase.allTransNum']}(元)" />
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="allTransNum" value="#{triskcaseForm.triskcase.allTransNum}"  style="width:'86%'"   tabindex="7" styleClass="edit_input">
					    <s:commonsValidator type="floatRange" min="0" max="1000000000" arg="#{text['triskcase.allTransNum']}" client="true" server="false" />
				      </be:inputNumber>
                               </h:panelGroup>	            <h:inputHidden />
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="score" value="#{triskcaseForm.triskcase.score}"  style="width:'86%'"   tabindex="8" styleClass="edit_input">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <be:inputAmount id="relativeTransAmt" value="#{triskcaseForm.triskcase.relativeTransAmt}" styleClass="edit_input" style="width:'86%'" tabindex="14" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="urgentCnt" value="#{triskcaseForm.triskcase.urgentCnt}"  readonly="false"  tabindex="23"  style="width:86%" >
