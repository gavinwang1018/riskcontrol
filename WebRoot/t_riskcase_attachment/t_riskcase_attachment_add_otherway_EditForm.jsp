...
<f:view>
	...
	<h:form id="triskcaseAttachmentForm" enctype="multipart/form-data" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcaseAttachment.t_riskcase_attachment_add_otherway_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseAttachmentForm.save}" tabindex="1" 
					  onclick=" if(!validateTriskcaseAttachmentForm(document.getElementById('triskcaseAttachmentForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_riskcase_attachment_add_otherway.2c908349171feac4011720237364001d']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase/t_riskcase_form_view_otherway_ViewForm.faces?_key=#{triskcaseAttachmentForm.triskcaseAttachment.riskcaseId}" />						
					</h:commandLink>
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
