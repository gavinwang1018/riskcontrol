...
<body onload="loadTriskcaseLog();getDateObj();">
<center>
...
<f:view>
	...
	<t:saveState value="#{triskcaseLogForm.triskcaseLog}" />

	<h:form id="triskcaseLogForm" style="width:96%;">
	<div class="mytab1">
	    <ul class="myTabBar1">
	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcaseLog.t_riskcase_log_form_EditForm.heading']}" /></a></li>
	    </ul>
	</div>
	<a4j:jsFunction name="loadTriskcaseLog" action="#{triskcaseLogForm.loadTriskcaseLog}" reRender="triskcaseLogForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['triskcaseLog.t_riskcase_log_form_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
			<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
		     ...
		     <f:verbatim><li></f:verbatim>
		      <h:commandLink action="#{triskcaseLogForm.popSave}" tabindex="1"  onclick="  if(!validateTriskcaseLogForm(document.getElementById('triskcaseLogForm')))return; ">
					<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_riskcase_log_form.2c908349169f7cda0116a4379a280543']}"/>
					</h:commandLink>
					<f:verbatim></li></f:verbatim>
			<f:verbatim><li></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="userMame" value="#{triskcaseLogForm.triskcaseLog.userMame}" style="width:'86%'" tabindex="2"   maxlength="20"  styleClass="edit_input" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			        <h:panelGroup>
			           <be:inputDate id="operatorDatetime" value="#{triskcaseLogForm.triskcaseLog.operatorDatetime}" style="width:86%" tabindex="3"   styleClass="edit_input" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="ip" value="#{triskcaseLogForm.triskcaseLog.ip}" style="width:'86%'" tabindex="4"   maxlength="20"  styleClass="edit_input" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="content" value="#{triskcaseLogForm.triskcaseLog.content}" style="width:'86%'" tabindex="5"   maxlength="20"  styleClass="edit_input" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="loginName" value="#{triskcaseLogForm.triskcaseLog.loginName}" style="width:'86%'" tabindex="6"   maxlength="20"  styleClass="edit_input" >
	...
	<s:validatorScript functionName="validateTriskcaseLogForm" />	
