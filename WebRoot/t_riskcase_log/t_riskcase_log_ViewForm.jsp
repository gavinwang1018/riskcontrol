...
<LI class="Selected" onclick="changeChildListForm(this,'triskcaseLogForm');"><a href="#"><h:outputText value="#{text['triskcaseLog.t_riskcase_log_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{triskcaseLogForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_log.2c908349169f7cda0116a42b47010519']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase_log/t_riskcase_log_EditForm.faces?_key=#{triskcaseLogForm.triskcaseLog.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{triskcaseLogForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_log.2c908349169f7cda0116a42b4720051a']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
