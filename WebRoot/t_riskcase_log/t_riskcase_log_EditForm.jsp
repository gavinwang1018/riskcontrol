...
<f:view>
	...
	<h:form id="triskcaseLogForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcaseLog.t_riskcase_log_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseLogForm.save}" tabindex="1" 
					  onclick=" if(!validateTriskcaseLogForm(document.getElementById('triskcaseLogForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_riskcase_log.2c908349169f7cda0116a42b46f10518']}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
