...
if (resultPage == null) {
 ...
 %>
<title><%=resultPage.getMessageTypeLabel()%></title>
...
.MessageBox {
	MARGIN: 100px auto; WIDTH: 451px
}
.MessageBox .Title {
	PADDING-LEFT: 20px; FONT-WEIGHT: bold; BACKGROUND: url(<%=Tools.getEnvionment("image_path")%>/MessageBox_Title.gif) no-repeat 50% top; WIDTH: 431px; PADDING-TOP: 15px; HEIGHT: 25px
}
.MessageBox .Body {
	BORDER-RIGHT: #e6e6e6 1px solid; BORDER-LEFT: #e6e6e6 1px solid; WIDTH: 449px; PADDING-TOP: 20px; HEIGHT: 150px
}
.MessageBox .Body .Icon {
	BACKGROUND: url(<%=Tools.getEnvionment("image_path")%>/result_<%=resultPage.getMessageType()%>.gif) no-repeat 20px top; FLOAT: left; WIDTH: 100px; HEIGHT: 100%
}
...
try{var loadImg=parent.document.getElementById("loading");
if(loadImg!=undefined&&loadImg.style.display=="")loadImg.style.display='none';}catch(e){}
</script>
<body>
