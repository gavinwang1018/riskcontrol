...
try{
	parent.historyIframe.addHistory('/t_mchnt_app/t_mchnt_app_form_detailview_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tmchntAppForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="tmchntApp.t_mchnt_app_form_detailview_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tmchntAppForm.tmchntApp.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'tmchntAppForm');"><a href="#"><h:outputText value="#{text['tmchntApp.t_mchnt_app_form_detailview_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{tmchntAppForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_mchnt_app_form_detailview.2c90834916f534a20116f6d020c000b6']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_mchnt_app/t_mchnt_app_form_detailview_EditForm.faces?_key=#{tmchntAppForm.tmchntApp.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{tmchntAppForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_mchnt_app_form_detailview.2c90834916f534a20116f6d020d000b7']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
