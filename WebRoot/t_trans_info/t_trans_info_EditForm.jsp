...
<f:view>
	...
	<h:form id="ttransInfoForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['ttransInfo.t_trans_info_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{ttransInfoForm.save}" tabindex="1" 
					  onclick=" if(!validateTtransInfoForm(document.getElementById('ttransInfoForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_trans_info.2c90834917aea6a90117afaf44cc004a']}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
