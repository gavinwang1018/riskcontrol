...
<LI class="Selected" onclick="changeChildListForm(this,'ttransInfoForm');"><a href="#"><h:outputText value="#{text['ttransInfo.t_trans_info_view_form_ViewForm.heading']}" /></a></LI>
