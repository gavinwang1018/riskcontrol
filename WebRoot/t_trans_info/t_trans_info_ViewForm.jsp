...
try{
	parent.historyIframe.addHistory('/t_trans_info/t_trans_info_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{ttransInfoForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="ttransInfo.t_trans_info_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{ttransInfoForm.ttransInfo.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'ttransInfoForm');"><a href="#"><h:outputText value="#{text['ttransInfo.t_trans_info_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{ttransInfoForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_trans_info.2c90834917aea6a90117afaf451b004b']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_trans_info/t_trans_info_EditForm.faces?_key=#{ttransInfoForm.ttransInfo.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{ttransInfoForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_trans_info.2c90834917aea6a90117afaf4549004c']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim></ul></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_trans_info.2c90834917aea6a90117afaf3ea2002a']}" />
			</f:facet>
