...
<body onload="loadTtransInfo();loadHidInfo();">
<center>
<jsp:include flush="true" page="../common/infobar.jsp"></jsp:include>
<f:view>
<script language=javascript>
try{
	parent.historyIframe.addHistory('/t_trans_info/t_trans_info_view_form_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{ttransInfoForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','交易流水信息(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{ttransInfoForm.ttransInfo.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
	...
	<h:form id="ttransInfoForm" style="width:96%">
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['ttransInfo.t_trans_info_view_form_ViewForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div></f:verbatim>
	<a4j:jsFunction name="loadTtransInfo" action="#{ttransInfoForm.loadTtransInfo}" reRender="ttransInfoForm"></a4j:jsFunction>		
