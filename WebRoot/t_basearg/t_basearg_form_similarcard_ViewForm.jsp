...
try{
	parent.historyIframe.addHistory('/t_basearg/t_basearg_form_similarcard_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tbaseargForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="tbasearg.t_basearg_form_similarcard_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tbaseargForm.tbasearg.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'tbaseargForm');"><a href="#"><h:outputText value="#{text['tbasearg.t_basearg_form_similarcard_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{tbaseargForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_basearg_form_similarcard.2c908349173e897b01173e9b9ef6003a']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_basearg/t_basearg_form_similarcard_EditForm.faces?_key=#{tbaseargForm.tbasearg.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{tbaseargForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_basearg_form_similarcard.2c908349173e897b01173e9b9f05003b']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim></ul></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_basearg_form_similarcard.2c908349173e897b01173e9b9e3a0033']}" />
			</f:facet>
