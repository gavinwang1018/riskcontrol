...
<f:view>
	...
	<a4j:jsFunction name="loadTbasearg" action="#{tbaseargForm.loadTbasearg}" reRender="tbaseargForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['tbasearg.t_basearg_form_warnleveledit_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
	           ...
	           <h:panelGroup>
	             <f:verbatim><span class="mustw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="param1" value="#{tbaseargForm.tbasearg.param1}" style="width:'86%'" tabindex="2"   maxlength="20"  styleClass="edit_input" >
	           ...
	           <h:panelGroup>
	             <f:verbatim><span class="mustw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="param2" value="#{tbaseargForm.tbasearg.param2}" style="width:'86%'" tabindex="3"   maxlength="20"  styleClass="edit_input" >
