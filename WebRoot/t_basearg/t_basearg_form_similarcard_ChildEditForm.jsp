...
<body onload="loadTbasearg();getDateObj();">
<center>
...
<f:view>
	...
	<div class="mytab1">
	    <ul class="myTabBar1">
	      <li class="Selected"><a href="#"><h:outputText value="#{text['tbasearg.t_basearg_form_similarcard_EditForm.heading']}" /></a></li>
	    </ul>
	</div>
	<a4j:jsFunction name="loadTbasearg" action="#{tbaseargForm.loadTbasearg}" reRender="tbaseargForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['tbasearg.t_basearg_form_similarcard_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
			<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
		     ...
		     <f:verbatim><li></f:verbatim>
		      <h:commandLink action="#{tbaseargForm.popSave}" tabindex="1"  onclick="  if(!validateTbaseargForm(document.getElementById('tbaseargForm')))return; ">
					<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_basearg_form_similarcard.2c908349173e897b01173e9b9ec70039']}"/>
					</h:commandLink>
					<f:verbatim></li></f:verbatim>
			<f:verbatim><li></f:verbatim>
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="type" value="#{tbaseargForm.tbasearg.type}" style="width:'86%'" tabindex="3"   maxlength="20"  styleClass="edit_input" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="code" value="#{tbaseargForm.tbasearg.code}" style="width:'86%'" tabindex="4"   maxlength="20"  styleClass="edit_input" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="param2" value="#{tbaseargForm.tbasearg.param2}" style="width:'86%'" tabindex="6"   maxlength="20"  styleClass="edit_input" >
