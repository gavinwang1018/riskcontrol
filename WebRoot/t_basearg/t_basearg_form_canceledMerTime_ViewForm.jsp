...
<LI class="Selected" onclick="changeChildListForm(this,'tbaseargForm');"><a href="#"><h:outputText value="#{text['tbasearg.t_basearg_form_canceledMerTime_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{tbaseargForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_basearg_form_canceledMerTime.2c908349173e897b01173e9ce1d6004e']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_basearg/t_basearg_form_canceledMerTime_EditForm.faces?_key=#{tbaseargForm.tbasearg.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{tbaseargForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_basearg_form_canceledMerTime.2c908349173e897b01173e9ce1e5004f']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
