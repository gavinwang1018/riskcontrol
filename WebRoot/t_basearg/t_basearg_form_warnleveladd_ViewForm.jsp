...
try{
	parent.historyIframe.addHistory('/t_basearg/t_basearg_form_warnleveladd_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tbaseargForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="tbasearg.t_basearg_form_warnleveladd_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tbaseargForm.tbasearg.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'tbaseargForm');"><a href="#"><h:outputText value="#{text['tbasearg.t_basearg_form_warnleveladd_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{tbaseargForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_basearg_form_warnleveladd.2c908349171a86da01171a9212ae0030']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_basearg/t_basearg_form_warnleveladd_EditForm.faces?_key=#{tbaseargForm.tbasearg.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{tbaseargForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_basearg_form_warnleveladd.2c908349171a86da01171a9212bd0031']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
