...
try{
	parent.historyIframe.addHistory('/t_keo_mchnt/t_keo_mchnt_form_reasonedit_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tkeoMchntForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="tkeoMchnt.t_keo_mchnt_form_reasonedit_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tkeoMchntForm.tkeoMchnt.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'tkeoMchntForm');"><a href="#"><h:outputText value="#{text['tkeoMchnt.t_keo_mchnt_form_reasonedit_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{tkeoMchntForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_keo_mchnt_form_reasonedit.2c90834916f534a20116f5a529e70012']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_keo_mchnt/t_keo_mchnt_form_reasonedit_EditForm.faces?_key=#{tkeoMchntForm.tkeoMchnt.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{tkeoMchntForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_keo_mchnt_form_reasonedit.2c90834916f534a20116f5a52a060013']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
