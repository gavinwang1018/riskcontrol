...
<f:view>
	...
	<h:form id="truleInstanceMccForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['truleInstanceMcc.t_rule_instance_mcc_form_view_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{truleInstanceMccForm.save}" tabindex="1" 
					  onclick=" if(!validateTruleInstanceMccForm(document.getElementById('truleInstanceMccForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_rule_instance_mcc_form_view.2c90834916ad22cb0116b2a6651901a3']}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
