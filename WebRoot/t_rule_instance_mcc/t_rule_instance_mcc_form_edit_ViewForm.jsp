...
<LI class="Selected" onclick="changeChildListForm(this,'truleInstanceMccForm');"><a href="#"><h:outputText value="#{text['truleInstanceMcc.t_rule_instance_mcc_form_edit_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{truleInstanceMccForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_rule_instance_mcc_form_edit.2c90834916ad22cb0116b2a5e1910188']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_rule_instance_mcc/t_rule_instance_mcc_form_edit_EditForm.faces?_key=#{truleInstanceMccForm.truleInstanceMcc.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{truleInstanceMccForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_rule_instance_mcc_form_edit.2c90834916ad22cb0116b2a5e1a10189']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
