...
<body onload="loadTrule();getDateObj();">
<center>
...
<f:view>
	...
	<t:saveState value="#{truleForm.trule}" />

	<h:form id="truleForm" style="width:96%;">
	<div class="mytab1">
	    <ul class="myTabBar1">
	      <li class="Selected"><a href="#"><h:outputText value="#{text['trule.t_rule_form_edit_EditForm.heading']}" /></a></li>
	    </ul>
	</div>
	<a4j:jsFunction name="loadTrule" action="#{truleForm.loadTrule}" reRender="truleForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['trule.t_rule_form_edit_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
			<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
		     ...
		     <f:verbatim><li></f:verbatim>
		      <h:commandLink action="#{truleForm.popSave}" tabindex="1"  onclick="  if(!validateTruleForm(document.getElementById('truleForm')))return; ">
					<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_rule_form_edit.2c90834916ad22cb0116b32f0204020a']}"/>
					</h:commandLink>
					<f:verbatim></li></f:verbatim>
			<f:verbatim><li></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_rule_form_edit.2c90834916ad22cb0116b32f01680204']}" />
			</f:facet>	
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="id" value="#{truleForm.trule.id}" style="width:'86%'" tabindex="2"   maxlength="3"  styleClass="edit_input" 	rendered="#{empty truleForm.trulePrimaryKey}" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="description" value="#{truleForm.trule.description}" style="width:'86%'" tabindex="3"   maxlength="100"  styleClass="edit_input" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			        <h:selectBooleanCheckbox id="supportTrace" value="#{truleForm.trule.supportTrace}"  readonly="false"  tabindex="4">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			        <h:selectBooleanCheckbox id="transInfo" value="#{truleForm.trule.transInfo}"  readonly="false"  tabindex="5">
                    </h:selectBooleanCheckbox>
                               </h:panelGroup>	            <h:inputHidden />
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
	<h:panelGroup>
				          <h:selectOneMenu id="type" value="#{truleForm.trule.type}"  readonly="false"  tabindex="6"  style="width:86%">
	...
	<s:validatorScript functionName="validateTruleForm" />	
