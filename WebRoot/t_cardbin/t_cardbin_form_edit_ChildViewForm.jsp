...
try{
	...
	<h:form id="tcardbinForm" style="width:96%">
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['tcardbin.t_cardbin_form_edit_ViewForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div></f:verbatim>
	<a4j:jsFunction name="loadTcardbin" action="#{tcardbinForm.loadTcardbin}" reRender="tcardbinForm"></a4j:jsFunction>		
