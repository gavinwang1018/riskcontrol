...
<f:view>
	...
	<a4j:jsFunction name="loadTcardbin" action="#{tcardbinForm.loadTcardbin}" reRender="tcardbinForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['tcardbin.t_cardbin_form_2_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
			<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
		     ...
		     <f:verbatim><li></f:verbatim>
		      <h:commandLink action="#{tcardbinForm.popSave}" tabindex="1"  onclick="if(!confirm('您确认要保存吗？')) return false;  if(!validateTcardbinForm(document.getElementById('tcardbinForm')))return; ">
