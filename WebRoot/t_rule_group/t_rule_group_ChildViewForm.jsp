...
try{
	...
	<h:form id="truleGroupForm" style="width:96%">
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['truleGroup.t_rule_group_ViewForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div></f:verbatim>
	<a4j:jsFunction name="loadTruleGroup" action="#{truleGroupForm.loadTruleGroup}" reRender="truleGroupForm"></a4j:jsFunction>		
