...
<LI class="Selected" onclick="changeChildListForm(this,'triskprocessTimelimitForm');"><a href="#"><h:outputText value="#{text['triskprocessTimelimit.t_riskprocess_timelimit_form_add_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{triskprocessTimelimitForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskprocess_timelimit_form_add.2c908349171a86da01171aa172a70061']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskprocess_timelimit/t_riskprocess_timelimit_form_add_EditForm.faces?_key=#{triskprocessTimelimitForm.triskprocessTimelimit.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{triskprocessTimelimitForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskprocess_timelimit_form_add.2c908349171a86da01171aa172c60062']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
