...
<f:view>
	...
	<h:form id="tmccForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['tmcc.t_mcc_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{tmccForm.save}" tabindex="1" 
					  onclick=" if(!validateTmccForm(document.getElementById('tmccForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_mcc.2c908349169f7cda0116a4147600047f']}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
