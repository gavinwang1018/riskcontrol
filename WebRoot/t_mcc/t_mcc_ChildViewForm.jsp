...
try{
	...
	<h:form id="tmccForm" style="width:96%">
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['tmcc.t_mcc_ViewForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div></f:verbatim>
	<a4j:jsFunction name="loadTmcc" action="#{tmccForm.loadTmcc}" reRender="tmccForm"></a4j:jsFunction>		
