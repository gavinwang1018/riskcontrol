...
<LI class="Selected" onclick="changeChildListForm(this,'truleInstanceForm');"><a href="#"><h:outputText value="#{text['truleInstance.t_rule_instance_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{truleInstanceForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_rule_instance.2c908349169f7cda0116a990bbf506ff']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_rule_instance/t_rule_instance_EditForm.faces?_key=#{truleInstanceForm.truleInstance.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{truleInstanceForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_rule_instance.2c908349169f7cda0116a990bc430700']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
