...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{tuserInfoForm.save}" tabindex="1"  rendered="#{sessionScope._user_info.actionMap['action.20'] == 'true'}"
					  onclick=" if(!validateTuserInfoForm(document.getElementById('tuserInfoForm')))return; ">
						...
						<t:updateActionListener property="#{actionParameter.successAction}" value="t_user_info/t_user_info_list_List" />						
					</h:commandLink>
<f:verbatim></li></f:verbatim>
