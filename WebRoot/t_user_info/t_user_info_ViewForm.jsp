...
try{
	parent.historyIframe.addHistory('/t_user_info/t_user_info_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tuserInfoForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="tuserInfo.t_user_info_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tuserInfoForm.tuserInfo.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'tuserInfoForm');"><a href="#"><h:outputText value="#{text['tuserInfo.t_user_info_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{tuserInfoForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_user_info.2c908349169f7cda0116a9936f7d076a']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_user_info/t_user_info_EditForm.faces?_key=#{tuserInfoForm.tuserInfo.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{tuserInfoForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_user_info.2c908349169f7cda0116a9936f9c076b']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
