...
try{
	parent.historyIframe.addHistory('/t_mchnt/t_mchnt_list_merandapp_List.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tmchntList.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>',"<fmt:message key="tmchnt.t_mchnt_list_merandapp_List.heading" />","2")
}catch(e){}
</script>
	...
	<h:form id="tmchntQuery" >
		...
		<h:panelGrid columns="2" cellspacing="0" cellpadding="0"  columnClasses="width50percent,width50percent" styleClass="width100percent"> 
             <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
				<h:outputLabel styleClass="fontnormal" for="subinst" value="#{text['tmchnt.subinst']}  #{text['query.equal']}" />				
				<h:panelGroup>
             ...
             <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
				...
				<h:panelGroup>
			    <h:inputText id="name_like" value="#{tmchntList.queryFields.name_like}" tabindex="2" styleClass="edit_input"/>
				</h:panelGroup>
			  </h:panelGrid>

             <h:panelGrid columns="2" cellspacing="2" cellpadding="5" styleClass="sectionTableSearch" columnClasses="colTitleSearch,colValueSearch">
				<h:outputLabel styleClass="fontnormal" for="merchantcategory" value="#{text['tmchnt.merchantcategory']}  #{text['query.equal']}" />				
				<h:panelGroup>
				<h:selectOneMenu id="merchantcategory" value="#{tmchntList.queryFields.merchantcategory}">
					<f:selectItem itemLabel="------" itemValue=""/>
	...
	<h:form id="tmchntList"  style="display:none">
<script>
