...
try{
	parent.historyIframe.addHistory('/t_mchnt/t_mchnt_List.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tmchntList.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>',"<fmt:message key="tmchnt.t_mchnt_List.heading" />","2")
}catch(e){}
</script>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{tmchntList.edit}"  onclick="if(rowIndexVarOfTmchnt == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_mchnt.2c908349169f7cda0116a3d0b25801e8']}" />
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{tmchntList.view}" onclick="if(rowIndexVarOfTmchnt == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkViewImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_mchnt.2c908349169f7cda0116a3d0b26801e9']}" />
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			 <h:commandLink  onclick="if(rowIndexVarOfTmchnt == -1){alert('#{text['button.selected.confirm']}')}else if(confirm('#{text['button.confirm.delete']}')){deleteTmchnt();}return false" >
				<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_mchnt.2c908349169f7cda0116a3d0b28701ea']}" />
			</h:commandLink>	
	</h:panelGroup>
<f:verbatim></li></f:verbatim>
	...
	<f:verbatim><li></f:verbatim>
		<h:commandLink action="#{tmchntList.add}"  >
			<f:verbatim><span class="linkAddImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistform.t_mchnt.2c908349169f7cda0116a3d0b23901e7']}" />
