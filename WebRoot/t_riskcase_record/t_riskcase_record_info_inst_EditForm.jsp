...
<LI class="Selected"><a href="#"><h:outputText value="触发子规则信息" /></a></LI>
    	...
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_info_inst_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseRecordForm.save}" tabindex="1" 
					  onclick="if(checkField())return false;">
						...
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase/t_riskcase_form_inst_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
		            <h:commandLink onclick="window.open('../t_riskcase/t_riskcase_form_inst_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}','_self','');return false" >
