...
<f:view>
	...
	<a4j:jsFunction name="loadTriskcaseRecord" action="#{triskcaseRecordForm.loadTriskcaseRecord}" reRender="triskcaseRecordForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_add_actionend_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
			...
			<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
		     ...
		     <f:verbatim><li></f:verbatim>
		      <h:commandLink action="#{triskcaseRecordForm.popSave}" tabindex="1"  onclick="  if(!validateTriskcaseRecordForm(document.getElementById('triskcaseRecordForm')))return; ">
					<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_riskcase_record_add_actionend.2c90834917143e5201171595a9350051']}"/>
					</h:commandLink>
					<f:verbatim></li></f:verbatim>
			<f:verbatim><li></f:verbatim>
