...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseRecordForm.save}" tabindex="1" 
					  onclick="if(checkField())return false;">
						...
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase/t_riskcase_form_depend_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
		            <h:commandLink onclick="window.open('../t_riskcase/t_riskcase_form_depend_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}','_self','');return false" >
