...
try{
	parent.historyIframe.addHistory('/t_riskcase_record/t_riskcase_record_info_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseRecordForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="triskcaseRecord.t_riskcase_record_info_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseRecordForm.triskcaseRecord.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'triskcaseRecordForm');"><a href="#"><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_info_ViewForm.heading']}" /></a></LI>
