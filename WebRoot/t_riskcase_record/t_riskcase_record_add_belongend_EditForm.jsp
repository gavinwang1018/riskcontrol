...
<LI class="Selected"><a href="#"><h:outputText value="触发子规则信息" /></a></LI>
    	...
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_add_belongend_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseRecordForm.save}" tabindex="1" 
					  onclick="if(checkField())return false;">
						...
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase/t_riskcase_form_belongend_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
		            <h:commandLink onclick="window.open('../t_riskcase/t_riskcase_form_belongend_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}','_self','');return false" >
...
<f:verbatim></li></f:verbatim>
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="otherInvestigationWay" value="#{triskcaseRecordForm.triskcaseRecord.otherInvestigationWay}" style="width:'86%'" tabindex="5"   maxlength="255"  styleClass="edit_input" disabled="true">
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <h:inputText id="pickCnt" value="#{triskcaseRecordForm.triskcaseRecord.pickCnt}"  style="width:'86%'"   tabindex="7" styleClass="edit_input" disabled="true">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <be:inputAmount id="pickAmt" value="#{triskcaseRecordForm.triskcaseRecord.pickAmt}" styleClass="edit_input" style="width:'86%'" tabindex="8" >
				     ...
				     </be:inputAmount><f:verbatim>(元)</f:verbatim>
                               </h:panelGroup>	            <h:inputHidden />
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <h:inputText id="pick180Cnt" value="#{triskcaseRecordForm.triskcaseRecord.pick180Cnt}"  style="width:'86%'"   tabindex="9" styleClass="edit_input" disabled="true">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <be:inputAmount id="pick180Amt" value="#{triskcaseRecordForm.triskcaseRecord.pick180Amt}" styleClass="edit_input" style="width:'86%'" tabindex="10" disabled="true">
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="pickStatus" value="#{triskcaseRecordForm.triskcaseRecord.pickStatus}"  readonly="false"  tabindex="11"  style="width:86%" onchange="hiddenPickStatus();" disabled="true" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <h:inputText id="pickFlawCnt" value="#{triskcaseRecordForm.triskcaseRecord.pickFlawCnt}"  style="width:'86%'" maxlength="255"   tabindex="12" styleClass="edit_input" disabled="true">
				      </h:inputText>
                               </h:panelGroup>	            <h:inputHidden />
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <h:inputText id="pickEmptyCnt" value="#{triskcaseRecordForm.triskcaseRecord.pickEmptyCnt}"  style="width:'86%'" maxlength="255" tabindex="13" styleClass="edit_input" disabled="true">
				      </h:inputText>
                               </h:panelGroup>	            <h:inputHidden />
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="riskLevel" value="#{triskcaseRecordForm.triskcaseRecord.riskLevel}"  readonly="false"  tabindex="15"  style="width:86%" disabled="true">
                            <f:selectItem itemLabel="----" itemValue=""/>
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="riskType" value="#{triskcaseRecordForm.triskcaseRecord.riskType}"  readonly="false"  tabindex="16"  style="width:86%" onchange="hiddenRiskType();"  disabled="true">
                            <f:selectItem itemLabel="----" itemValue=""/>
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="otherRiskType" value="#{triskcaseRecordForm.triskcaseRecord.otherRiskType}" style="width:'86%'" tabindex="17"   maxlength="255"  styleClass="edit_input" disabled="true">
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                        <h:panelGroup>
						<h:selectOneMenu id="process2Type" value="#{triskcaseRecordForm.triskcaseRecord.process2Type}"  readonly="false"  tabindex="16"  style="width:86%"  disabled="true">
                            <f:selectItem itemLabel="----" itemValue=""/>
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                        <h:panelGroup>
                           <f:verbatim><table class="radioGroup"><tr><td></f:verbatim>
						<be:groupCheckbox id="processType" value="#{triskcaseRecordForm.processType}" readonly="false" cols="4"  tabindex="18" onclick="hiddenProcessType();" disabled="true" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <h:inputText id="processFreezeAmt" value="#{triskcaseRecordForm.triskcaseRecord.processFreezeAmt}"  style="width:'86%'"   tabindex="19" styleClass="edit_input"  disabled="true">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <h:inputText id="processWithdrawCnt" value="#{triskcaseRecordForm.triskcaseRecord.processWithdrawCnt}"  style="width:'86%'"   tabindex="20" styleClass="edit_input"  disabled="true">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="otherProcessType" value="#{triskcaseRecordForm.triskcaseRecord.otherProcessType}" style="width:'86%'" tabindex="21"   maxlength="255"  styleClass="edit_input"  disabled="true">
