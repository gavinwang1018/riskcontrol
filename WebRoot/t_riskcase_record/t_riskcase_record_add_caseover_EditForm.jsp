...
<f:view>
	...
	<h:form id="triskcaseRecordForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_add_caseover_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseRecordForm.save}" tabindex="1" 
					  onclick=" if(!validateTriskcaseRecordForm(document.getElementById('triskcaseRecordForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_riskcase_record_add_caseover.2c90834917143e5201171597dfbc007f']}" />
...
<f:verbatim></li></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_record_add_caseover.2c90834917143e5201171597e0870082']}" />
			</f:facet>	
	...
	<h:panelGroup>
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			        <h:selectBooleanCheckbox id="isPickFlow" value="#{triskcaseRecordForm.triskcaseRecord.isPickFlow}"  readonly="false"  tabindex="5">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="pickCnt" value="#{triskcaseRecordForm.triskcaseRecord.pickCnt}"  style="width:'86%'"   tabindex="6" styleClass="edit_input">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <be:inputAmount id="pickAmt" value="#{triskcaseRecordForm.triskcaseRecord.pickAmt}" styleClass="edit_input" style="width:'86%'" tabindex="7" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="pick180Cnt" value="#{triskcaseRecordForm.triskcaseRecord.pick180Cnt}"  style="width:'86%'"   tabindex="8" styleClass="edit_input">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <be:inputAmount id="pick180Amt" value="#{triskcaseRecordForm.triskcaseRecord.pick180Amt}" styleClass="edit_input" style="width:'86%'" tabindex="9" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="pickStatus" value="#{triskcaseRecordForm.triskcaseRecord.pickStatus}"  readonly="false"  tabindex="10"  style="width:86%" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="pickFlawCnt" value="#{triskcaseRecordForm.triskcaseRecord.pickFlawCnt}"  style="width:'86%'"   tabindex="11" styleClass="edit_input">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="pickEmptyCnt" value="#{triskcaseRecordForm.triskcaseRecord.pickEmptyCnt}"  style="width:'86%'"   tabindex="12" styleClass="edit_input">
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="investigationResult" value="#{triskcaseRecordForm.triskcaseRecord.investigationResult}"  readonly="false"  tabindex="13"  style="width:86%" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="riskLevel" value="#{triskcaseRecordForm.triskcaseRecord.riskLevel}"  readonly="false"  tabindex="14"  style="width:86%" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="riskType" value="#{triskcaseRecordForm.triskcaseRecord.riskType}"  readonly="false"  tabindex="15"  style="width:86%" >
	...
	<h:panelGroup>
				          ...
				          <h:selectOneMenu id="processType" value="#{triskcaseRecordForm.triskcaseRecord.processType}"  readonly="false"  tabindex="16"  style="width:86%" >
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="processFreezeAmt" value="#{triskcaseRecordForm.triskcaseRecord.processFreezeAmt}"  style="width:'86%'"   tabindex="17" styleClass="edit_input">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
			          <be:inputNumber id="processWithdrawCnt" value="#{triskcaseRecordForm.triskcaseRecord.processWithdrawCnt}"  style="width:'86%'"   tabindex="18" styleClass="edit_input">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                      ...
                      <h:panelGroup>
			              <h:inputTextarea id="description" value="#{triskcaseRecordForm.triskcaseRecord.description}" rows="4" style="width:'86%';"   readonly="false" tabindex="19" styleClass="edit_textarea" >
                          </h:inputTextarea>			
