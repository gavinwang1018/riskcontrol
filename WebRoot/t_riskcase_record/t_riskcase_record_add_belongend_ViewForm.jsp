...
try{
	parent.historyIframe.addHistory('/t_riskcase_record/t_riskcase_record_add_belongend_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseRecordForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="triskcaseRecord.t_riskcase_record_add_belongend_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseRecordForm.triskcaseRecord.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'triskcaseRecordForm');"><a href="#"><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_add_belongend_ViewForm.heading']}" /></a></LI>
...
<f:verbatim></ul></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_record_add_belongend.2c9083491781cf8f01178ab80d0d005d']}" />
			</f:facet>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_record_add_belongend.2c9083491781cf8f01178ab80d5b0060']}" />
			</f:facet>
...
<f:verbatim></td></tr></table></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_record_add_belongend.2c9083491781cf8f01178ab80db80063']}" />
			</f:facet>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_record_add_belongend.2c9083491781cf8f01178ab80e93006c']}" />
			</f:facet>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_record_add_belongend.2c9083491781cf8f01178ab80f100071']}" />
			</f:facet>
...
<f:verbatim></td></tr></table></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader">
			<f:facet name="header">
				<h:outputText value="#{text['section.t_riskcase_record_add_belongend.2c9083491781cf8f01178ab80f9d0076']}" />
			</f:facet>
