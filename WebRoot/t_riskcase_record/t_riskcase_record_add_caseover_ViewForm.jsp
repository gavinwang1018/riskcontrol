...
try{
	parent.historyIframe.addHistory('/t_riskcase_record/t_riskcase_record_add_caseover_ViewForm.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseRecordForm.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>','<fmt:message key="triskcaseRecord.t_riskcase_record_add_caseover_ViewForm.heading" />(<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseRecordForm.triskcaseRecord.id}").getValue(FacesContext.getCurrentInstance()) %>)',"1")
}catch(e){}
</script>
...
<LI class="Selected" onclick="changeChildListForm(this,'triskcaseRecordForm');"><a href="#"><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_add_caseover_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{triskcaseRecordForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_record_add_caseover.2c90834917143e5201171597dfcb0080']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase_record/t_riskcase_record_add_caseover_EditForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{triskcaseRecordForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_record_add_caseover.2c90834917143e5201171597dfeb0081']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
