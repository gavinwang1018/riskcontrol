...
<LI class="Selected"><a href="#"><h:outputText value="触发子规则信息" /></a></LI>
    	...
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['triskcaseRecord.t_riskcase_record_add_actionend_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{triskcaseRecordForm.save}" tabindex="1" 
					  onclick="if(checkField())return false;">
						...
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase/t_riskcase_form_actionend_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
		            <h:commandLink onclick="window.open('../t_riskcase/t_riskcase_form_actionend_ViewForm.faces?_key=#{triskcaseRecordForm.triskcaseRecord.riskcaseId}','_self','');return false" >
...
<f:verbatim></li></f:verbatim>
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="sectionTable" headerClass="sectionHeader" footerClass="mainFooter2">
			...
			<h:panelGrid columns="2" cellspacing="0" cellpadding="0" styleClass="sectionTable" columnClasses="colTitle,colValue">
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
				    <h:inputText id="pick180Amt" value="#{triskcaseRecordForm.triskcaseRecord.pick180Amt}" styleClass="edit_input" style="width:'86%'" tabindex="10" disabled="true">
