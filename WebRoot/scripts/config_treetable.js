...
function treetable_hideRow(rowId) {
  ...
  el.style.display = "none";
   parent.dyniframesize('mainFrame');
}
...
function treetable_collapseAll(tableId) {
  ...
  document.getElementById("treeButton").onclick=treetable_expandAll;
  document.getElementById("treeButton").value="全部展开";
  parent.dyniframesize('mainFrame');
  return (true);
}    
...
function treetable_expandAll() {
  ...
  document.getElementById("treeButton").onclick=treetable_collapseAll;
  document.getElementById("treeButton").value="全部收拢";
   parent.dyniframesize('mainFrame');
  return (true);
}
