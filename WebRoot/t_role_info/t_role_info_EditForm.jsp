...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{troleInfoForm.save}" tabindex="1"  rendered="#{sessionScope._user_info.actionMap['action.21'] == 'true'}"
					  onclick=" if(!validateTroleInfoForm(document.getElementById('troleInfoForm')))return; ">
