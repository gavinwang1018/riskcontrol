...
try{
	...
	<h:form id="troleInfoForm" style="width:96%">
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['troleInfo.t_role_info_ViewForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div></f:verbatim>
	<a4j:jsFunction name="loadTroleInfo" action="#{troleInfoForm.loadTroleInfo}" reRender="troleInfoForm"></a4j:jsFunction>		
