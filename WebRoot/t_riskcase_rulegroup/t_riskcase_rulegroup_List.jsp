...
try{
	parent.historyIframe.addHistory('/t_riskcase_rulegroup/t_riskcase_rulegroup_List.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{triskcaseRulegroupList.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>',"<fmt:message key="triskcaseRulegroup.t_riskcase_rulegroup_List.heading" />","2")
}catch(e){}
</script>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{triskcaseRulegroupList.edit}"  onclick="if(rowIndexVarOfTriskcaseRulegroup == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_riskcase_rulegroup.2c908349169f7cda0116a408828d0419']}" />
				<t:updateActionListener property="#{actionParameter.successAction}" value="t_riskcase_rulegroup/t_riskcase_rulegroup_form_EditForm" />
			</h:commandLink>							
	</h:panelGroup>
<f:verbatim></li></f:verbatim>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{triskcaseRulegroupList.view}" onclick="if(rowIndexVarOfTriskcaseRulegroup == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkViewImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_riskcase_rulegroup.2c908349169f7cda0116a40882ad041a']}" />
				<t:updateActionListener property="#{actionParameter.successAction}" value="t_riskcase_rulegroup/t_riskcase_rulegroup_form_ViewForm" />
			</h:commandLink>	
	</h:panelGroup>
<f:verbatim></li></f:verbatim>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			 <h:commandLink  onclick="if(rowIndexVarOfTriskcaseRulegroup == -1){alert('#{text['button.selected.confirm']}')}else if(confirm('#{text['button.confirm.delete']}')){deleteTriskcaseRulegroup();}return false" >
				<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_riskcase_rulegroup.2c908349169f7cda0116a40882bc041b']}" />
			</h:commandLink>	
	</h:panelGroup>
<f:verbatim></li></f:verbatim>
	...
	<f:verbatim><li></f:verbatim>
		<h:commandLink action="#{triskcaseRulegroupList.add}"  >
			<f:verbatim><span class="linkAddImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistform.t_riskcase_rulegroup.2c908349169f7cda0116a408827e0418']}" />
			<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase_rulegroup/t_riskcase_rulegroup_form_EditForm.faces" />
		</h:commandLink>
	<f:verbatim></li></f:verbatim>
