...
<LI class="Selected" onclick="changeChildListForm(this,'triskcaseRulegroupForm');"><a href="#"><h:outputText value="#{text['triskcaseRulegroup.t_riskcase_rulegroup_form_ViewForm.heading']}" /></a></LI>
...
<f:verbatim><li></f:verbatim>
					<h:commandLink action="#{triskcaseRulegroupForm.edit}">				
						<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_rulegroup_form.2c908349169f7cda0116a408e4160421']}" />
						<t:updateActionListener property="#{actionParameter.successAction}" value="url:../t_riskcase_rulegroup/t_riskcase_rulegroup_form_EditForm.faces?_key=#{triskcaseRulegroupForm.triskcaseRulegroup.id}"/>
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
<f:verbatim><li></f:verbatim>
					<h:commandLink
						action="#{triskcaseRulegroupForm.delete}" onclick="if(!confirm('#{text['button.confirm.delete']}'))return false;">
						<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionview.t_riskcase_rulegroup_form.2c908349169f7cda0116a408e4260422']}" />
					</h:commandLink>	
<f:verbatim></li></f:verbatim>
