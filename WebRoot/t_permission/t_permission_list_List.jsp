...
try{
	parent.historyIframe.addHistory('/t_permission/t_permission_list_List.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tpermissionList.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>',"<fmt:message key="tpermission.t_permission_list_List.heading" />","2")
}catch(e){}
</script>
...
<br>
		<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['tpermission.t_permission_list_List.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{tpermissionList.edit}"  onclick="if(rowIndexVarOfTpermission == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkEditImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_permission_list.2c90834916c1da250116c2125ac6003d']}" />
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{tpermissionList.view}" onclick="if(rowIndexVarOfTpermission == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				<f:verbatim><span class="linkViewImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_permission_list.2c90834916c1da250116c2125ad5003e']}" />
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			 <h:commandLink  onclick="if(rowIndexVarOfTpermission == -1){alert('#{text['button.selected.confirm']}')}else if(confirm('#{text['button.confirm.delete']}')){deleteTpermission();}return false" >
				<f:verbatim><span class="linkDelImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistrec.t_permission_list.2c90834916c1da250116c2125af5003f']}" />
			</h:commandLink>	
	</h:panelGroup>
<f:verbatim></li></f:verbatim>
	...
	<f:verbatim><li></f:verbatim>
		<h:commandLink action="#{tpermissionList.add}"  >
			<f:verbatim><span class="linkAddImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionlistform.t_permission_list.2c90834916c1da250116c2125aa6003c']}" />
	...
	<f:verbatim></li></f:verbatim>
		...
		<h:panelGrid columns="2" styleClass="scrollerTable" columnClasses="column1,column2">
            <t:dataScroller id="tpermission_scroll_1" 
                    for="tpermissionDataTable"
            ...
            <t:dataScroller id="tpermission_scroll_2" 
                    for="tpermissionDataTable"
                    rowsCountVar="rowsCount"
                    displayedRowsCountVar="displayedRowsCountVar"
                    firstRowIndexVar="firstRowIndex"
