...
<f:view>
	...
	<h:form id="tpermissionForm" style="width:96%;">
    	<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['tpermission.t_permission_form_EditForm.heading']}" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
		            <h:commandLink action="#{tpermissionForm.save}" tabindex="1" 
					  onclick=" if(!validateTpermissionForm(document.getElementById('tpermissionForm')))return; ">
						<f:verbatim><span class="linkSaveImg"></span></f:verbatim><h:outputText styleClass="buttonText" value="#{text['actionedit.t_permission_form.2c90834916c1da250116c21207f30035']}" />
					</h:commandLink>
<f:verbatim></li></f:verbatim>
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="priviledeId" value="#{tpermissionForm.tpermission.priviledeId}" style="width:'86%'" tabindex="2"   maxlength="32"  styleClass="edit_input" >
	           ...
	           <h:panelGroup>
		         <f:verbatim><span class="notw"></span></f:verbatim>
                   <h:panelGroup>
		               ...
		               <h:inputText id="priviledeType" value="#{tpermissionForm.tpermission.priviledeType}" style="width:'86%'" tabindex="3"   maxlength="20"  styleClass="edit_input" >
