...
<body onload="loadTpermission();getDateObj();">
<center>
...
<f:view>
	...
	<a4j:jsFunction name="loadTpermission" action="#{tpermissionForm.loadTpermission}" reRender="tpermissionForm" oncomplete="loadDateSelect()"></a4j:jsFunction>
    	<f:verbatim><div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"></f:verbatim><h:outputText value="#{text['tpermission.t_permission_EditForm.heading']}" /><f:verbatim></a></li>
    	    </ul>
    	</div>
		</f:verbatim>
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable">
			<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
		     ...
		     <f:verbatim><li></f:verbatim>
		      <h:commandLink action="#{tpermissionForm.popSave}" tabindex="1"  onclick="  if(!validateTpermissionForm(document.getElementById('tpermissionForm')))return; ">
