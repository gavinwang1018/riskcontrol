...
<body onload="loadHidInfo();getDateObj()">
	...
	<div class="title" title="疑似风险商户案例处理时间统计表">
				...
				<h:panelGrid id="searchtab" columns="1" cellspacing="0"
					...
					<h:panelGroup>
						<h:commandButton value="#{text['button.query']}"
							action="#{reportList.queryVariousTime}" onclick="return isEmpty();"
							styleClass="button">
						</h:commandButton>
						<h:commandButton value="导出Excel文件" action="#{reportList.exportVariousTime}"
