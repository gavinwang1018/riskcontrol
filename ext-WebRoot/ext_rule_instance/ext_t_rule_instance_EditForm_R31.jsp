...
<input type="hidden" name="cycle" value="<%=cycle%>">
				...
				<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
					...
					<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
						...
						<f:facet name="header">
							<h:outputText
								value="子规则 #{truleInstanceForm.truleInstance.code}--已触发过规则的商户" />
						</f:facet>
 ...
 <f:verbatim><img src="../images/newdate.gif" class="datebutton"  onclick="event.cancelBubble=true;new Calendar().show(this)"  /></f:verbatim>					               
				</t:column>
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="param3" arrow="true">		                
							<h:outputText value="该段时间的商户累计触发规则次数" />
						</t:commandSortHeader>	
				</f:facet><f:verbatim><span class="mustw"></span></f:verbatim>
