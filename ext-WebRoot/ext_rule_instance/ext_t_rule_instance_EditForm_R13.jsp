...
<input type="hidden" name="cycle" value="<%=cycle%>">
				...
				<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
					...
					<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
						...
						<f:facet name="header">
							<h:outputText
								value="子规则 #{truleInstanceForm.truleInstance.code}--每个商户在非正常营业时间发生的交易" />
						</f:facet>
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="param1" arrow="true">		                
							<h:outputText value="非正常开始时间 (HHmm,输入时分 如1230)" />
						</t:commandSortHeader>	
				</f:facet><f:verbatim><span class="mustw"></span></f:verbatim>
							        <h:inputText id="param1" value="#{extTruleInstanceMcc.param1}" tabindex="11" >
					               </h:inputText>
				</t:column>
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="param2" arrow="true">		                
							<h:outputText value="非正常结束时间 (HHmm,输入时分 如1230)" />
						</t:commandSortHeader>	
				</f:facet><f:verbatim><span class="mustw"></span></f:verbatim>
						           <h:inputText id="param2" value="#{extTruleInstanceMcc.param2}" tabindex="11" >
					               </h:inputText>
				</t:column>
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="param3" arrow="true">		                
							<h:outputText value="该段时间的商户累计触发交易笔数" />
						</t:commandSortHeader>	
				</f:facet><f:verbatim><span class="mustw"></span></f:verbatim>
				<h:inputText id="param3" value="#{extTruleInstanceMcc.param3}"/>
				</t:column>
	...
	<f:verbatim></li></f:verbatim>
			...
			<t:dataTable id="truleInstanceMccDataTable" var="truleInstanceMcc"
				...
				<t:column>
					...
					<h:selectOneMenu id="mccCode" value="#{truleInstanceMcc.mccId}">
					...
					<f:facet name="header">
						<t:commandSortHeader columnName="param1" arrow="true">		                
							<h:outputText value="非正常开始时间 (HHmm,输入时分 如1230)" />
							        ...
							        <h:inputText id="param1" value="#{truleInstanceMcc.param1}" tabindex="11" style="width:80%" >
					               </h:inputText>
				</t:column>
					...
					<f:facet name="header">
						<t:commandSortHeader columnName="param2" arrow="true">		                
							<h:outputText value="非正常结束时间 (HHmm,输入时分 如1230)" />
						           ...
						           <h:inputText id="param2" value="#{truleInstanceMcc.param2}" tabindex="11" style="width:80%" >
					               </h:inputText>
				</t:column>
				...
				<h:inputText id="param3" value="#{truleInstanceMcc.param3}" style="width:80%" />
				</t:column>
