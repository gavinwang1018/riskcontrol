...
<body onload="loadTruleInstanceBigMccList();loadChild();getDateObj();loadDateSelect()">
<script>
...
<f:verbatim><input type="hidden" name="cycle" value="<%=cycle%>"></f:verbatim>	
				<div class="mytab1">
					<ul class="myTabBar1">
						<li class="Selected">
							<a href="#"><h:outputText
				...
				<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
					...
					<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
						...
						<f:facet name="header">
							<h:outputText
								value="子规则#{truleInstanceForm.truleInstance.code}--一段时间内商户信用卡单笔交易金额超限" />
						</f:facet>
