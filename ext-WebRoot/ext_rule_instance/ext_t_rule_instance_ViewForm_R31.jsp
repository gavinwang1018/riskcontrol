	...
	<h:panelGrid  id="extTruleInstanceMccPanel" columns="1" cellspacing="0" cellpadding="0" styleClass="mainTable" >	
		...
		<h:panelGrid columns="1" cellspacing="1" cellpadding="2" styleClass="titleTable" columnClasses="titleTdClass" >
			...
			<t:dataTable id="extTruleInstanceMccDataTable" var="extTruleInstanceMcc"
				...
				<h:outputText id="param1" value="#{extTruleInstanceMcc.param1}"/>
				</t:column>
				...
				<h:outputText id="param2" value="#{extTruleInstanceMcc.param2}"/>
				</t:column>
				...
				<h:outputText id="param3" value="#{extTruleInstanceMcc.param3}"/>
				</t:column>
