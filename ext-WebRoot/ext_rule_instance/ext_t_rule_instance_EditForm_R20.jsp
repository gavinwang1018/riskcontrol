...
<input type="hidden" name="cycle" value="<%=cycle%>">
				...
				<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
					...
					<h:panelGrid columns="1" cellspacing="0" cellpadding="0"
						...
						<f:facet name="header">
							<h:outputText
								value="子规则 #{truleInstanceForm.truleInstance.code}--查询岂止时间段内商户交易总金额介于一定程度的商户" />
						</f:facet>
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="param1" arrow="true">		                
							<h:outputText value="交易总金额小阀值 (元)   (参数1)" />
						</t:commandSortHeader>	
				</f:facet><f:verbatim><span class="mustw"></span></f:verbatim>
				<h:inputText id="param1" value="#{extTruleInstanceMcc.param1}"/>
				</t:column>

				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="param2" arrow="true">		                
							<h:outputText value="交易总金额大阀值 (元)   (参数2)" />
						</t:commandSortHeader>	
				</f:facet><f:verbatim><span class="mustw"></span></f:verbatim>
				<h:inputText id="param2" value="#{extTruleInstanceMcc.param2}"/>
				</t:column>				
...
<f:verbatim></li></f:verbatim>
	...
	<f:verbatim></li></f:verbatim>
			...
			<t:dataTable id="truleInstanceMccDataTable" var="truleInstanceMcc"
				...
				<h:inputText id="param1" value="#{truleInstanceMcc.param1}"/>
				</t:column>
				...
				<h:inputText id="param2" value="#{truleInstanceMcc.param2}"/>
				</t:column>
