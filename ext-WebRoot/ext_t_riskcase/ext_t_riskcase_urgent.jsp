...
function selAll(){
	var allInputs=document.getElementById("triskcaseList").getElementsByTagName("input");
	...
	<h:form id="triskcaseQuery" >
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
			<h:panelGroup>
				...
				<f:verbatim><li></f:verbatim>
				<h:commandLink  onclick="if(compareDate()) {alert('处理时限结束日期不能小于起始日期!');return false;}else{queryTriskcases();return false;}">
...
<br>
		<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="需督办的案例信息" /></a></li>
    	    </ul>
    	</div>
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{triskcaseList.view}" onclick="if(rowIndexVarOfTriskcase == -1){alert('#{text['button.selected.confirm']}');return false}" >				   
				...
				<t:updateActionListener property="#{actionParameter.successAction}" value="ext_t_riskcase/ext_t_riskcase_form_urgent_ViewForm" />
			</h:commandLink>	
	</h:panelGroup>
<f:verbatim></li></f:verbatim>     
...
<f:verbatim></li></f:verbatim>
			...
			<t:dataTable id="triskcaseDataTable" var="triskcase"
				value="#{triskcaseList.triskcases}" rowClasses="rowsClass,rowsClass2" rowIndexVar="rowIndexVar" rows="20"
				...
				<h:outputText id="transMcc" value="#{triskcase.transMcc}" />
				</t:column>												
				...
				<t:column>
					<f:facet name="header">
						<t:commandSortHeader columnName="triggerContent" arrow="true">		                
							<h:outputText value="#{text['triskcase.triggerContent']}" />
						</t:commandSortHeader>	
				</f:facet>
				<h:outputText id="triggerContent" value="#{triskcase.triggerContent}" />
				</t:column>				
