...
<h:form id="triskcaseQuery" >
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
			<h:panelGroup>
				...
				<f:verbatim><li></f:verbatim>
				<h:commandLink  onclick="if(compareDateOfCreate()) {return false;} else{queryTriskcases();return false;}">
...
<h:panelGrid columns="2" cellspacing="0" cellpadding="0"  columnClasses="width50percent,width50percent" styleClass="width100percent"> 
	...
	<a4j:jsFunction name="sendTriskcase" action="#{triskcaseList.send}"  reRender="triskcasePanel,triskcases" />
...
<f:verbatim><li></f:verbatim>
	<h:panelGroup >
			<h:commandLink action="#{triskcaseList.send}" onclick="if(myCheck()){alert('请选择要下发的案例');return false}else if(confirm('确定下发')){;}else{return false;}">				   
            ...
            <f:selectItems value="#{extSelectItems.belongToInstList}"/>
				...
				<t:column>
					<f:facet name="header">
			           ...
			           <be:inputDate id="processLimit" value="#{triskcaseForm.triskcase.processLimit}" style="width:80px;" tabindex="11"   styleClass="edit_input" >
					     <f:convertDateTime pattern="yyyy-MM-dd" timeZone="GMT+8"/>
		               </be:inputDate>		
				</t:column>
