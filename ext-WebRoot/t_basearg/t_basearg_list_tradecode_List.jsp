...
try{
	parent.historyIframe.addHistory('/t_basearg/t_basearg_list_tradecode_List.faces?<%=FacesContext.getCurrentInstance().getApplication().createValueBinding("#{tbaseargList.historyUrlParameter}").getValue(FacesContext.getCurrentInstance())%>',"<fmt:message key="tbasearg.t_basearg_list_tradecode_List.heading" />","2")
}catch(e){}
</script>
	...
	<div class="mytab1">
   	    <ul class="myTabBar1">
   	      <li class="Selected"><a href="#" onmouseup="hidShowSearchImg('tbaseargQuery:searchtab')"><h:outputText value="交易码查询" /><h:graphicImage id="searchImgId" styleClass="searchImgClass" url="../images/button_showall.gif" /></a></li>
   	    </ul>
   	</div>
	
	<h:form id="tbaseargQuery" >
		<a4j:jsFunction name="queryTbaseargs" action="#{tbaseargList.queryTradeCode}" reRender="tbaseargPanel,tbaseargs" oncomplete="document.getElementById('tbaseargList').style.display='block';parent.dyniframesize('mainFrame')" />   
		...
		<h:panelGrid columns="1" cellspacing="0" cellpadding="0" styleClass="titleTable" columnClasses="titleTdClass" >
			<h:panelGroup>
				...
				<f:verbatim><li></f:verbatim>
				<h:commandLink  onclick="queryTbaseargs();return false;" rendered="#{sessionScope._user_info.actionMap['action.35'] == 'true'}">
	...
	<h:form id="tbaseargList"  style="display:none">
<script>
...
<br>
		<div class="mytab1">
    	    <ul class="myTabBar1">
    	      <li class="Selected"><a href="#"><h:outputText value="#{text['tbasearg.t_basearg_list_tradecode_List.heading']}" /></a></li>
    	    </ul>
    	</div>
		...
		<h:panelGrid columns="1" cellspacing="1" cellpadding="2" styleClass="titleTable" columnClasses="titleTdClass" >
			...
			<t:dataTable id="tbaseargDataTable" var="tbasearg"
				...
				<be:outputText id="code" value="#{tbasearg.code}">
                   <f:selectItem itemLabel="交易码" itemValue="ProcCode"/>
				</be:outputText>
				</t:column>
